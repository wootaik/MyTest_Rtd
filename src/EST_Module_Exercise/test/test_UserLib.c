...
void setUp(void){
	MyHyst.fltHystState = OUT_OFF;
	MyHyst.fltUpperThreshold = HYST_ON;
	MyHyst.fltUpperOutput = OUT_ON;
	MyHyst.fltLowerThreshold = HYST_OFF;
	MyHyst.fltLowerOutput = OUT_OFF;
